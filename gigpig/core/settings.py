...
WSGI_APPLICATION = 'gigpig.core.wsgi.application'
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'gigpig.core.password_validators.NoSpacesPasswordValidator',
    },
]
...
DJOSER = {
    'LOGIN_FIELD': 'email',
    'SERIALIZERS': {
        'token_create': 'gigpig.api.auth.serializers.TokenCreateSerializer',
        'current_user': 'gigpig.api.users.serializers.CurrentUserSerializer',
        'user_create_password_retype':
            'gigpig.api.users.serializers.CreatePasswordRetypeSerializer',
    },
